...
export const Main = () => {
	return (
		<section
			className='w-full px-4 flex flex-col items-center justify-evenly bg-[#FEF5E7]'
			id='aboutUs'
		>
			<AnimatedText />
			<Small>Eduardo Galeano.</Small>
			<div className=' w-full py-16 flex flex-col items-center md:flex-row-reverse text-[#2C3E50] justify-center bg-[#FEF5E7]'>
